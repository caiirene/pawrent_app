...
class ChatMessagesRecord extends FirestoreRecord {
  ...
  // "Help_referene" field.
  DocumentReference? _helpReferene;
  DocumentReference? get helpReferene => _helpReferene;
  bool hasHelpReferene() => _helpReferene != null;
  ...
  void _initializeFields() {
    ...
    _helpReferene = snapshotData['Help_referene'] as DocumentReference?;
  }
...
Map<String, dynamic> createChatMessagesRecordData({
  ...
  String? image,
  DateTime? timestamp,
  DocumentReference? helpReferene,
}) {
