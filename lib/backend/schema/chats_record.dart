...
class ChatsRecord extends FirestoreRecord {
  ...
  // "Help_ref" field.
  DocumentReference? _helpRef;
  DocumentReference? get helpRef => _helpRef;
  bool hasHelpRef() => _helpRef != null;

  // "User_a_notme_firstname" field.
  String? _userANotmeFirstname;
  String get userANotmeFirstname => _userANotmeFirstname ?? '';
  bool hasUserANotmeFirstname() => _userANotmeFirstname != null;
  ...
  void _initializeFields() {
    ...
    _helpRef = snapshotData['Help_ref'] as DocumentReference?;
    _userANotmeFirstname = snapshotData['User_a_notme_firstname'] as String?;
  }
...
Map<String, dynamic> createChatsRecordData({
  ...
  DocumentReference? helpRef,
  String? userANotmeFirstname,
}) {
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'Help_ref': helpRef,
      'User_a_notme_firstname': userANotmeFirstname,
    }.withoutNulls,
  );
