...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF883F39);
  late Color secondary = const Color(0xFFF7F0E8);
  late Color tertiary = const Color(0xFFCBAAA2);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFF883F39);
  late Color secondaryText = const Color(0xFFCBAAA2);
  late Color primaryBackground = const Color(0xFFF7F0E8);
  ...
  late Color primaryBtnText = Color(0xFFF7F0E8);
  late Color background = Color(0xFFF7F0E8);
  late Color teaRoseRed = Color(0xFFF3C1BC);
  late Color rosyBrown = Color(0xFFCBAAA2);
  late Color font = Color(0xFF883F39);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFF883F39);
  late Color secondaryText = const Color(0xFFF7F0E8);
