...
class DogProfilePageModel extends FlutterFlowModel {
  ...
  String? _dogNameControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Field is required';
    }

    if (val.length < 2) {
      return 'Please enter your dog name ';
    }
  ...
  void initState(BuildContext context) {
    dogNameControllerValidator = _dogNameControllerValidator;
  }
