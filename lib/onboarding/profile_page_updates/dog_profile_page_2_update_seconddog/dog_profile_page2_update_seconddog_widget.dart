...
import 'dog_profile_page2_update_seconddog_model.dart';
export 'dog_profile_page2_update_seconddog_model.dart';

class DogProfilePage2UpdateSeconddogWidget extends StatefulWidget {
  const DogProfilePage2UpdateSeconddogWidget({Key? key}) : super(key: key);

  @override
  _DogProfilePage2UpdateSeconddogWidgetState createState() =>
      _DogProfilePage2UpdateSeconddogWidgetState();
}

class _DogProfilePage2UpdateSeconddogWidgetState
    extends State<DogProfilePage2UpdateSeconddogWidget> {
  late DogProfilePage2UpdateSeconddogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DogProfilePage2UpdateSeconddogModel());
