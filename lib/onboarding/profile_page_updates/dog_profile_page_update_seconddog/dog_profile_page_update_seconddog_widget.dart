...
import 'dog_profile_page_update_seconddog_model.dart';
export 'dog_profile_page_update_seconddog_model.dart';

class DogProfilePageUpdateSeconddogWidget extends StatefulWidget {
  const DogProfilePageUpdateSeconddogWidget({Key? key}) : super(key: key);

  @override
  _DogProfilePageUpdateSeconddogWidgetState createState() =>
      _DogProfilePageUpdateSeconddogWidgetState();
}

class _DogProfilePageUpdateSeconddogWidgetState
    extends State<DogProfilePageUpdateSeconddogWidget> {
  late DogProfilePageUpdateSeconddogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DogProfilePageUpdateSeconddogModel());
