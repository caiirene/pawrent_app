...
import 'post_photos_model.dart';
export 'post_photos_model.dart';

class PostPhotosWidget extends StatefulWidget {
  const PostPhotosWidget({Key? key}) : super(key: key);
...
class _PostPhotosWidgetState extends State<PostPhotosWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostPhotosModel());
                          ...
                          builder: (context) =>
                            ...
                            builder: (context, snapshot) {
                              ...
                              final imagePostsRecord =
                                  imagePostsRecordList.isNotEmpty
