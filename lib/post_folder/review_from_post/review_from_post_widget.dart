...
import 'review_from_post_model.dart';
export 'review_from_post_model.dart';

class ReviewFromPostWidget extends StatefulWidget {
  const ReviewFromPostWidget({
    Key? key,
    required this.reviewTo,
  }) : super(key: key);

  final DocumentReference? reviewTo;

  @override
  _ReviewFromPostWidgetState createState() => _ReviewFromPostWidgetState();
}

class _ReviewFromPostWidgetState extends State<ReviewFromPostWidget> {
  late ReviewFromPostModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReviewFromPostModel());
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(24.0, 30.0, 24.0, 30.0),
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'How many days?(round numbers only)',
            ...
            Container(
              ...
              child: Padding(
                padding: EdgeInsetsDirectional.fromSTEB(24.0, 30.0, 24.0, 12.0),
                child: TextFormField(
                  ...
                  obscureText: false,
                  decoration: InputDecoration(
                    hintText: 'Say thank you and leave a reivew',
                      ...
                      await showDialog(
                        ...
                        builder: (alertDialogContext) {
                          return AlertDialog(
                            ...
                            content: Text(
                                'Your review helps build a better community. '),
                            actions: [
                              TextButton(
                                onPressed: () =>
